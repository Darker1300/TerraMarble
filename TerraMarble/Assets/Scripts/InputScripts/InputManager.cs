...
public class InputManager : MonoBehaviour
{
    ...
    private InputIdentifier leftMouseDragID;

    private InputIdentifier rightMouseDragID;
    //---DRAG MOUSE/TOUCH--
    //START POS
    ...
    [SerializeField] private float TapMinDragAmount = 20;
    private float lastTapTime;
    private bool tapTimer;
    private IEnumerator DoubleTapQuery;
    ...
    [EnumFlags] public DragTypes testID = DragTypes.ALTERNATE;
