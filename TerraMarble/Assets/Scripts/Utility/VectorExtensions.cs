...
namespace MathUtility
{
    ...
    public static class VectorExtensions
    {
        ...
        public static Vector2Int Sign(this Vector2 vector)
            => new(System.Math.Sign(vector.x), System.Math.Sign(vector.y));


        public static Vector3Int Sign(this Vector3 vector)
            => new(System.Math.Sign(vector.x), System.Math.Sign(vector.y), System.Math.Sign(vector.z));
